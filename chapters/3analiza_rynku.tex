...
Amazon to jeden z największych serwisów e-commerce na całym świecie. Startował jako księgarnia internetowa, której asortyment systematycznie powiększał się, aż do dzisiejszych rozmiarów. Jedyną funkcjonalnością szczegółowego podglądu kupowanego przedmiotu jest powiększenie obrazka, który zapewnił nam sprzedający. Nie ma możliwości podglądu realnego stanu licytowanego przedmiotu. Sam proces kupowania czy licytowania jest bardzo intuicyjny i szybki, przez co użytkownik nie ma problemów. Amazon ma bardzo dobrze rozbudowaną obsługę klienta, przez co wszystkie problemy są rozwiązywane szybko i bezproblemowo.

%wsadzic tu focie

\subsection{erli.pl}
Założona w 2020 roku polska firma, która zajmuje się sektorem e-commerce. Odpowiada za sprzedaż przedmiotów w kategorii: meble, budowa i remont, ogród, oświetlenie, narzędzia i wyposażenie domu. Platforma ma prosty i przejrzysty układ strony z licytacją przedmiotu, lecz podgląd kupowanego przedmiotu ogranicza się tylko i wyłącznie do powiększania zdjęć oferowanych przez sprzedawcę. Takie rozwiązanie może nie oddawać dobrze faktur i tekstur przedmiotu, przez co użytkownik może mieć wątpliwości podczas zakupu. Wyświetlane zdjęcia zajmują małą część strony, co utrudnia ogląd licytowanego przedmiotu dla użytkowników, gdyż muszą powiększać stronę, aby dobrze obejrzeć zdjęcia zamieszczone przez sprzedającego, co sprawia, że licytowanie przedmiotu staje się dla użytkownika niepraktyczne.

\subsection{Wnioski}
Analiza ww. serwisów wskazuje, że brak możliwości podglądu produktów w technologii 3D ogranicza pełną ocenę przedmiotów przez konsumentów. Może to znacząco wpływać na wyższą liczbę zwrotów oraz obniżone zaufanie wśród użytkowników platformy. Wdrożenie łatwej w obsłudze technologii pozwalającej przyglądać się obiektom w trójwymiarze stanowi innowację i daje szansę na poprawę doświadczenia użytkownika, zwiększając jego satysfakcję.
