...
\subsection{Wnioski}
Analiza ww. serwisów wskazuje, że brak możliwości podglądu produktów w technologii 3D ogranicza pełną ocenę przedmiotów przez konsumentów. Może to znacząco wpływać na wyższą liczbę zwrotów oraz obniżone zaufanie wśród użytkowników platformy. Wdrożenie łatwej w obsłudze technologii renderowania 3D stanowi innowację, daje szansę na poprawę doświadczenia użytkownika, zwiększając jego satysfakcję.
