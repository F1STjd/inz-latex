...
\begin{enumerate}
  \item Wprowadzenie do technologii WebGPU i WebAssembly.
        \begin{itemize}
          ...
          \item Opis technologii WebAssembly i jej zastosowań w kontekście aplikacji internetowych.
        \end{itemize}
  ...
  \item Projekt i implementacja części klienckiej serwisu aukcyjnego.
        \begin{itemize}
          ...
          \item Stworzenie komponentów interfejsu użytkownika.
        \end{itemize}
  ...
  \item Ewaluacja i perspektywy rozwoju.
        \begin{itemize}
          \item Testowanie wydajności i testy serwisu aukcyjnego.
...
W tabeli \ref{tab:podzial_pracy} przedstawiono podział pracy pomiędzy autorów pracy inżynierskiej.

\begin{table}[H]
  \centering
  \caption{Podział pracy pomiędzy autorów}
  \label{tab:podzial_pracy}
  \begin{tabularx}{\textwidth}{|l|X|}
    \hline
    \textbf{Autor} & \textbf{Zakres odpowiedzialności}                                                           \\
    \hline
    \multirow{4}{*}{\parbox{4cm}{Konrad Tomasz                                                                   \\Nowak}}
                   & Wprowadzenie do renderowania 3D                                                             \\
                   & Opis technologii WebGPU i WebAssembly                                                       \\
                   & Projekt i implementacja komponentu renderującego                                            \\
                   & Pomiar wydajności komponentu renderującego                                                  \\
    \hline
    \multirow{7}{*}{\parbox{4cm}{Maciej                                                                          \\Ołdakowski}}
                   ...
                   & Implementacja autentykacji za pomocą tokenów JWT                                            \\
                   & Implementacja zarządzania aukcjami                                                          \\
                   & Implementacja ścieżek API części serwerowej                                                 \\
                   & Testowanie systemu aukcyjnego                                                               \\
    \hline
    \multirow{6}{*}{\parbox{4cm}{Patryk Kamil                                                                    \\Nowacki}}
                   & Implementacja interfejsu użytkownika serwisu aukcyjnego                                     \\
                   & Trasowanie i nawigacja w aplikacji React                                                    \\
                   & Komunikacja części klienckiej z częścią serwerową                                           \\
                   & Walidacja danych oraz obsługa błędów po stronie interfejsu użytkownika                      \\
                   & Integracja komponentu renderującego z systemem aukcyjnym                                    \\
                   & Architektura integracji w React z wykorzystaniem wzorca Provider i mechanizmu React Portals \\
    \hline
  \end{tabularx}
\end{table}
