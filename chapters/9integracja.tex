...
\subsection{Kompilacja do WebAssembly}
...
Plik \texttt{main.js} definiuje globalny obiekt \texttt{Module}, który stanowi interfejs komunikacji z kodem WebAssembly. Obiekt ten zawiera atrybutamy, które kod wygenerowany przez Emscripten wywołuje w różnych momentach swojego działania.
