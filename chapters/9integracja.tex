...
Przed załadowaniem skryptu Emscripten, konfigurowany jest globalny obiekt \texttt{window.Module} z callbackami obsługującymi zdarzenia cyklu życia, jak przedstawiono na listingu \ref{lst:module}:
