...
W badaniu wykorzystano model \textit{Stanford Dragon} -- klasyczny model testowy powszechnie stosowany w badaniach grafiki komputerowej~\cite{stanford-dragon}. Model ten został przygotowany w czterech wariantach o różnej złożoności geometrycznej:
\begin{itemize}
