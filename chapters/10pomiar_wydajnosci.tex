...
Przepustowość operacji ładowania, wyrażona jako liczba przetworzonych wierzchołków na sekundę, utrzymuje się na stabilnym poziomie około 1,4 miliona wierzchołków na sekundę dla modeli powyżej 10 tysięcy wierzchołków (rysunek \ref{fig:throughput}). Niższa przepustowość dla najmniejszego modelu 3D s(1,19 mln wierzch./s) wynika z narzutu związanego z inicjalizacją operacji wejścia/wyjścia.
...
\end{equation}
gdzie $\sigma$ oznacza odchylenie standardowe, a $\mu$ średnią arytmetyczną. Niższa wartość współczynnika zmienności świadczy o większej stabilności i powtarzalności pomiarów~\cite{Brown1998}.
