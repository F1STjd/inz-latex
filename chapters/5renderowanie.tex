...
\begin{itemize}
  \item \textbf{Dawn} – implementacja stworzona przez firmę Google, przy pomocy języka C++ - używana w przeglądarkach opartych na silniku Chromium.
  \item \textbf{wgpu} – implementacja stworzona przez firmę Mozilla, przy pomocy języka Rust - używana w przeglądarce Mozilla Firefox.
\end{itemize}
