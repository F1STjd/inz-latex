...
Wymagania niefunkcjonalne opisują działanie systemu od strony wydajności i ograniczeń systemu. Nie opisują działania systemu, lecz jego właściwości. 
\begin{itemize}
    \item Wydajność
          \begin{itemize}
...
Diagramy pakietów przypakdów użycia to diagramy UML grupujące przypadki użycia w grupy nazywane pakietami. Diagram ten pomaga organizować przypadki użycia w grupy, poprzez powiązane funkcjonalności. W tym diagramie pakiety są reprezentowane przez foldery, które zawierają przypadki użycia.  
\begin{center}
...
Historyjki użytkownika to opis funkcjonalności systemu, widziany przez użytkownika końcowego. Dzięki historyjkom, wiemy jakich funkcjonalności wymagaj poszczególni użytkownicy systemu.  
