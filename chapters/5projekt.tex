...
Diagramy BPMN (Business Process Model and Notation) służa do modelowania procesów biznesowych. Opisują sekwencje działań i przepływów w procesach danej organizacji. 
\begin{center}
...
\begin{figure}[htbp]
    ...
    \caption{Diagram przypadków użycia administracji i raportów}
    \label{fig:zdj7}
\end{figure}
...
\begin{landscape}
    \begin{figure}[p]
        ...
        \caption{Diagram klas procesu licytacji}
        \label{fig:zdj10}
    \end{figure}
    ...
    \begin{figure}[p]
        ...
        \caption{Diagram klas wizualizacji obiektu 3D}
        \label{fig:zdj11}
    \end{figure}
\end{landscape}
...
\begin{center}
    ...
    \captionof{figure}{Diagram sekwencji generowania raportów}
...
\begin{figure}[htbp]
    ...
    \caption{Diagram sekwencji moderacji aukcji}
    \label{fig:zdj14}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \caption{Diagram sekwencji tworzenia aukcji}
    \label{fig:zdj18}
\end{figure}

\subsection{Projekt interfejsu użytkownika}
W celu łatwiejszej pracy nad implementacją części klienckej serwisu aukcyjnego, utworzono widoki, które pokazują ogólny zamysł wyglądu aplikacji. Podczas implementacji interfejsów graficznych, była potrzebna na zmianę niektórych widoków, tak aby interfejs był bardziej przejrzysty i ujednolicony.
