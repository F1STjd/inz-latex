...
W celu łatwiejszej pracy nad implementacją części klienckiej serwisu aukcyjnego, utworzono widoki, które pokazują ogólny zamysł wyglądu aplikacji. Poniższe zdjęcia przedstawiają widoki strony głównej (rysunki \ref{fig:mockup1}, \ref{fig:mockup2}, \ref{fig:mockup3}, \ref{fig:mockup4}), widoku aukcji (rysunki \ref{fig:mockup5}, \ref{fig:mockup6}), panelu użytkownika (rysunek \ref{fig:mockup7}).
