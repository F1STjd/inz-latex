...
\end{lstlisting}
\vspace{5cm}
Na rysunku~\ref{fig:tests} przedstawiono sktueczność wszystkich testów zawartych w projekcie. Wszystkie napisane testy są kompilowane bezbłędnie, co oznacza, że najważniejsze części systemu aukcyjnego działają poprawnie.
